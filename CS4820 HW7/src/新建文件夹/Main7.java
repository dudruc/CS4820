...
class Main7 {
	...
	void output() {
		try {
			...
			out.write(arrToString(data));
					//arrToString(foreground).replace("true", "1").replace("false", "0")
			out.flush();
		} catch (Exception e) {
			e.printStackTrace();
		}
